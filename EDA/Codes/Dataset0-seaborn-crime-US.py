...
Crime<-read.csv('Dataset0-Crime_in_US.csv')
...
sns.regplot(x="year", y="value", data=crime_total)
f.suptitle('Total crime rate per 100,000 civilians in US from 1998-2017', fontsize=18, x=0.5, y=1.05)

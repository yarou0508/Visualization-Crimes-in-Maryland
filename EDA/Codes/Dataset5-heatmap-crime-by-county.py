...
f1, ax1 = plt.subplots(figsize=(17, 10))
sns.heatmap(table_violent, linewidths=.5, cmap = sns.cm.rocket_r)
ax1.set_title('Voilent Crime Percentage from 1975 to 2016')

f2, ax2 = plt.subplots(figsize=(17, 10))
sns.heatmap(table_property, linewidths=.5, cmap="YlGnBu")
